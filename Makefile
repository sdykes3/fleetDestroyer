...
SOURCES            = main.c myLib.c sound.c starsSmall.c starsBig.c howto.c text.c start.c splash.c sprites.c Ballad.c playerShot.c crash.c expl01.c expl02.c expl03.c explosion.c alert.c Powerup6.c Powerup8.c longCrash.c crash0.c
